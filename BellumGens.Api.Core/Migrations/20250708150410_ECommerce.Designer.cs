...
namespace BellumGens.Api.Core.Migrations
{
    ...
    [Migration("20250708150410_ECommerce")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BellumGens.Api.Core.Models.CSGOTeam", b =>
                {
                    ...
                    b.HasIndex("SteamGroupId")
                        .IsUnique()
                        .HasFilter("[SteamGroupId] IS NOT NULL");
            ...
            modelBuilder.Entity("BellumGens.Api.Core.Models.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BellumGens.Api.Core.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BellumGens.Api.Core.Models.ProductOrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BellumGens.Api.Core.Models.TournamentGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasDiscriminator().HasValue("TournamentGroup");

                    b.UseTphMappingStrategy();
                });

            modelBuilder.Entity("BellumGens.Api.Core.Models.TournamentGroupParticipant", b =>
                {
                    ...
                    b.HasKey("TournamentGroupId", "TournamentApplicationId");

                    b.HasIndex("TournamentApplicationId");

                    b.ToTable("TournamentGroupParticipants");
                });
            ...
            modelBuilder.Entity("BellumGens.Api.Core.Models.UserMapPool", b =>
                {
                    ...
                    b.Property<int>("Map")
                        .HasColumnType("int")
                        .HasAnnotation("Relational:JsonPropertyName", "mapId");
            ...
            modelBuilder.Entity("BellumGens.Api.Core.Models.TournamentCSGOGroup", b =>
                {
                    b.HasBaseType("BellumGens.Api.Core.Models.TournamentGroup");

                    b.HasIndex("TournamentId");

                    b.HasDiscriminator().HasValue("TournamentCSGOGroup");
                });
            ...
            modelBuilder.Entity("BellumGens.Api.Core.Models.TournamentSC2Group", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("TournamentSC2Group");
                });
            ...
            modelBuilder.Entity("BellumGens.Api.Core.Models.ProductOrderDetails", b =>
                {
                    b.HasOne("BellumGens.Api.Core.Models.Order", "Order")
                        .WithMany("OrderProducts")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BellumGens.Api.Core.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("BellumGens.Api.Core.Models.TournamentGroupParticipant", b =>
                {
                    b.HasOne("BellumGens.Api.Core.Models.TournamentApplication", "TournamentApplication")
                        .WithMany("GroupsPoints")
                        .HasForeignKey("TournamentApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BellumGens.Api.Core.Models.TournamentGroup", "TournamentGroup")
                        .WithMany("Participants")
                        .HasForeignKey("TournamentGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TournamentApplication");
