...
namespace BellumGens.Api.Core.Migrations
{
    ...
    [Migration("20241029134802_BGEBalkan")]
    partial class BGEBalkan
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BellumGens.Api.Core.Models.SC2LeagueApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SC2LeagueApplications");
                });
            ...
            modelBuilder.Entity("BellumGens.Api.Core.Models.SC2LeagueApplication", b =>
                {
                    b.HasOne("BellumGens.Api.Core.Models.Company", "Team")
                        .WithMany()
                        .HasForeignKey("TeamId");
