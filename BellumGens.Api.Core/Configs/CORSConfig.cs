namespace BellumGens.Api.Core
{
	public static class CORSConfig
	{
		...
		public static readonly string[] validOrigins = new string[] { "http://localhost:4200", "http://localhost:4000", "http://localhost:4201", "http://localhost:4001" };
#endif
		...
		public static readonly string[] validOrigins = new string[] { "https://bellumgens.com", "https://www.bellumgens.com", "https://eb-league.com", "https://www.eb-league.com", "http://staging.bellumgens.com", "http://staging.eb-league.com" };
#endif
